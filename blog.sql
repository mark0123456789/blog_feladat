...
(5, '0000-00-00 00:00:00', 'szeretem az autokat', 2, 6),
(6, '2025-03-14 11:13:11', '', 1, 0);
...
CREATE TABLE IF NOT EXISTS `blogtemak` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `beszelgetesneve` (`beszelgetesneve`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;


INSERT INTO `blogtemak` (`ID`, `beszelgetesneve`, `createdtime`) VALUES
(4, 'étel', '2025-02-28 13:00:24'),
(5, 'ital', '2025-02-28 13:00:34'),
(6, 'autok', '2025-02-28 13:03:26'),
(7, '@category', '2025-03-14 11:12:50');
